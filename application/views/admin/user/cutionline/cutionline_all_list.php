                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <?php foreach ($userlist as $user): ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $user['nbm']; ?></td>
                                    <td><?php echo $user['userpush']; ?></td>
                                    <td><?php echo my_date_show_time($user['dateadd']); ?></td>
                                    <td class="text-nowrap">

                                        <?php if ($this->session->userdata('role') == 'admin'): ?>
                                            <a href="<?php echo base_url('admin/cutionline/update/'.$user['no']) ?>" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-success m-r-10"></i> </a>
                                            ...
                                            <?php if ($user['userprivilege'] == "admin"): ?>
                                                    <a href="<?php echo base_url('admin/cutionline/user/'.$user['no']) ?>" data-toggle="tooltip" data-original-title="User"> <i class="fa fa-close text-danger m-r-10"></i> </a>
                                                <?php else: ?>
                                                    <a href="<?php echo base_url('admin/cutionline/admin/'.$user['no']) ?>" data-toggle="tooltip" data-original-title="Admin"> <i class="fa fa-check text-info m-r-10"></i> </a>
                                            <?php endif ?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            <div class="form-body">        
                ...
                <a href="<?php echo base_url('admin/cutionline/delete/'.$user['no']) ?>" class="btn btn-danger"> Delete</a>
            </div>
      </div>
    </div>
  </div>
