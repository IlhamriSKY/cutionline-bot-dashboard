            ...
            <div class="d-flex m-t-10 justify-content-end">
                <div class="d-flex m-r-20 m-l-10 hidden-md-down">
                    <div class="chart-text m-r-10">
                        <h6 class="m-b-0"><small>Total Command</small></h6>
        ...
        <div class="col-12">
            ...
            <div class="card">
                ...
                <?php if ($this->session->userdata('role') == 'admin'): ?>
                    <a href="<?php echo base_url('admin/cutionline/addcommand') ?>" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Add New Command</a> &nbsp;
                <?php else: ?>
                            ...
                            <?php foreach ($usercommand as $command): ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap">
                                        ...
                                        <?php if ($this->session->userdata('role') == 'admin'): ?>
                                            <a href="<?php echo base_url('admin/cutionline/update_command/'.$command['no']) ?>" data-toggle="tooltip" data-original-title="Edit"> <i class="fa fa-pencil text-success m-r-10"></i> </a>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-body">
                ...
                <a href="<?php echo base_url('admin/cutionline/delete_command/'.$command['no']) ?>" class="btn btn-danger"> Delete</a>
