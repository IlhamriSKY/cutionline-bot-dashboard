...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="<?php echo base_url() ?>assets/images/cutionline.png">
    <title>SMKM Admin Dashboard</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar card-no-border">
    ...
    <div id="main-wrapper">
                ...
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url('admin/dashboard') ?>">
                        ...
                        <b>
                            ...
                            <!-- Dark Logo icon -->
                            <!-- Light Logo icon -->
                            <img src="<?php echo base_url() ?>assets/images/185-Logomu.png" alt="homepage" class="light-logo" width="20%" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span>
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="<?php echo base_url('admin/user/all_user_list') ?>" aria-expanded="false"><i class="fa fa-users"></i><span class="hide-menu">User Bot</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/cutionline/userlist') ?>"><i class="fa fa-angle-right"></i> All Users</a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            ...
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url('admin/cutionline/usertext') ?>"><i class="fa fa-angle-right"></i> All User Text</a></li>
                                <li><a href="<?php echo base_url('admin/cutionline/usertext_status/no') ?>"><i class="fa fa-angle-right"></i> UnAnswered User Text</a></li>
                            </ul>
                        </li>
                        <li>
							...
							<?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/cutionline/addcommand') ?>"><i class="fa fa-angle-right"></i> Add Command </a></li>
                                <?php else: ?>
                                    <?php if(check_power(1)):?>
                                        <li><a href="<?php echo base_url('admin/cutionline/addcommand') ?>"><i class="fa fa-angle-right"></i> Add Command </a></li>
                                    <?php endif; ?>
                                ...
                                <li><a href="<?php echo base_url('admin/cutionline/command') ?>"><i class="fa fa-angle-right"></i> All Command</a></li>

                            </ul>
                        </li>

                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-clipboard-account"></i><span class="hide-menu">Karyawan</span></a>
                            <ul aria-expanded="false" class="collapse">

							<?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/cutionline/addkaryawan') ?>"><i class="fa fa-angle-right"></i> Add Karyawan </a></li>
                                <?php else: ?>
                                    <?php if(check_power(1)):?>
                                        <li><a href="<?php echo base_url('admin/cutionline/addkaryawan') ?>"><i class="fa fa-angle-right"></i> Add Karyawan </a></li>
                                    <?php endif; ?>
                                ...
                                <li><a href="<?php echo base_url('admin/cutionline/karyawan') ?>"><i class="fa fa-angle-right"></i> All Karyawan</a></li>

                            </ul>
                        </li>

                        <li>
                            <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-file-multiple"></i><span class="hide-menu">Cuti</span></a>
                            <ul aria-expanded="false" class="collapse">

							<?php if ($this->session->userdata('role') == 'admin'): ?>
                                    <li><a href="<?php echo base_url('admin/cutionline/addcuti') ?>"><i class="fa fa-angle-right"></i> Add Cuti </a></li>
                                <?php else: ?>
                                    <?php if(check_power(1)):?>
                                        <li><a href="<?php echo base_url('admin/cutionline/addcuti') ?>"><i class="fa fa-angle-right"></i> Add Cuti </a></li>
                                    <?php endif; ?>
                                ...
                                <li><a href="<?php echo base_url('admin/cutionline/cuti') ?>"><i class="fa fa-angle-right"></i> All Cuti</a></li>
        ...
        <!-- ==========================Dynamicaly Show Main Page Content============================ -->
            ...
            <footer class="footer">
                © 2019  <a href="https://github.com/IlhamriSKY">SMKM Admin Dashboard</a>
            </footer>
